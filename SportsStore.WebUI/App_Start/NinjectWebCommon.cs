...
namespace SportsStore.WebUI.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            //connection between Ninject and class NinjectDepencyResolver
            System.Web.Mvc.DependencyResolver.SetResolver(new SportsStore.WebUI.Infrastructure.NinjectDepencyResolver(kernel));
        }        
    }
}
